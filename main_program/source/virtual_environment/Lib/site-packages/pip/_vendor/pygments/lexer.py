...
class words(Future):
    """
    Indicates a list of literal words that is ed into an optimized
...
class RegexLexerMeta(LexerMeta):
    ...
    def _process_new_state(cls, new_state, unprocessed, processed):
        """Preprocess the state   action of a token definition."""
...
class RegexLexer(Lexer, metaclass=RegexLexerMeta):
    ...
    #:
    #: ``new_state`` can be omitted to signify no state  .
