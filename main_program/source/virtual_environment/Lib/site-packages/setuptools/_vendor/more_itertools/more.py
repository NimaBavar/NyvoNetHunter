...
def adjacent(predicate, iterable, distance=1):
    ...
    See also :func:`groupby_`, which can be used with this function
...
def groupby_(iterable, keyfunc=None, valuefunc=None, reducefunc=None):
    """An extension of :func:`itertools.groupby` that can apply ations
    to the grouped data.

    * *keyfunc* is a function computing a key value for each item in *iterable*
    * *valuefunc* is a function that s the individual items from
      *iterable* after grouping
    * *reducefunc* is a function that s each group of items

    >>> iterable = 'aAAbBBcCC'
    >>> keyfunc = lambda k: k.upper()
    >>> valuefunc = lambda v: v.lower()
    >>> reducefunc = lambda g: ''.join(g)
    >>> list(groupby_(iterable, keyfunc, valuefunc, reducefunc))
    [('A', 'aaa'), ('B', 'bbb'), ('C', 'ccc')]

    Each optional argument defaults to an identity function if not specified.

    :func:`groupby_` is useful when grouping elements of an iterable
    ...
    that extracts the second element::
        ...
        >>> grouper = groupby_(iterable, itemgetter(0), itemgetter(1))
...
def map_reduce(iterable, keyfunc, valuefunc=None, reducefunc=None):
    ...
    defined by *keyfunc*, s them with *valuefunc*, and
    ...
    *valuefunc* defaults to the identity function if it is unspecified.
    ...
    Specifying *valuefunc* s the categorized items:
...
def map_except(function, iterable, *exceptions):
    """ each item from *iterable* with *function* and yield the
    result, unless *function* raises one of the specified *exceptions*.

    *function* is called to  each item in *iterable*.
...
def _sample_weighted(iterable, k, weights):
    ...
    # Log- for numerical stability for weights that are small/large
