...
"}")
        ...
        self.label.setStyleSheet("QLabel{ border: 2px solid red; background-color: orange }\n"
"\n"
"QLabel:hover{\n"
"        background: qlineargradient(x1 : 0, y1 : 0, x2 : 0, y2 :   1, stop :   0.0 #ffd9aa,\n"
"                stop :   0.5 #ffbb6e, stop :   0.55 #feae42, stop :   1.0 #fedb74);\n"
...
"}")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.pushButton.setToolTip(_translate("Dialog", "<html><head/><body><p>Examine the IP!</p></body></html>"))
        self.pushButton.setText(_translate("Dialog", "Examine"))
        self.lineEdit.setToolTip(_translate("Dialog", "<html><head/><body><p>IP example: 144.145.146.147 ( IP addresses maximum octet digit is 255 )</p></body></html>"))
        ...
        self.checkBox_6.setToolTip(_translate("Dialog", "<html><head/><body><p>The IP user Internet Service Provider.</p><p><br/></p><p>Examples: Mobin Net Communication Company, SURFnet II c.</p></body></html>"))
        self.checkBox_6.setText(_translate("Dialog", "ISP"))
        self.checkBox_7.setToolTip(_translate("Dialog", "<html><head/><body><p>The IP user Internet Service Provider.</p><p><br/></p><p>Examples: Mobin Net Communication Company, SURFnet II c.</p></body></html>"))
        self.checkBox_7.setText(_translate("Dialog", "Show map location"))
        self.checkBox_8.setToolTip(_translate("Dialog", "<html><head/><body><p>The IP user Internet Service Provider.</p><p><br/></p><p>Examples: Mobin Net Communication Company, SURFnet II c.</p></body></html>"))
        self.checkBox_8.setText(_translate("Dialog", "latitude"))
        self.checkBox_9.setToolTip(_translate("Dialog", "<html><head/><body><p>The IP user Internet Service Provider.</p><p><br/></p><p>Examples: Mobin Net Communication Company, SURFnet II c.</p></body></html>"))
...
class NyvoaiApp(QDialog):
    ...
    def make_api_call(self, ip: str) -> str:
        ...
        api_key_value = QByteArray(NyvoaiApp.api_key.encode())
