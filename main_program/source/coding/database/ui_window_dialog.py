...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(
            QtGui.QPixmap("main_program/source/ui_design\\resources/pictures/icon.png"),
            QtGui.QIcon.Normal,
            QtGui.QIcon.Off,
        )
        ...
        self.callstatusLabel.setStyleSheet(
        ...
        self.countryCheckBox.setStyleSheet(
            "QCheckBox {\n"
            "  width: 35px;\n"
            "  height: 35px;\n"
            "  cursor: pointer;\n"
        ...
        self.regionCheckBox.setStyleSheet(
            "QCheckBox {\n"
            "  width: 35px;\n"
            "  height: 35px;\n"
            "  cursor: pointer;\n"
        ...
        self.cityCheckBox.setStyleSheet(
            "QCheckBox {\n"
            "  width: 35px;\n"
            "  height: 35px;\n"
            "  cursor: pointer;\n"
        ...
        self.zipcodeCheckBox.setStyleSheet(
            "QCheckBox {\n"
            "  width: 35px;\n"
            "  height: 35px;\n"
            "  cursor: pointer;\n"
        ...
        self.timezoneCheckBox.setStyleSheet(
            "QCheckBox {\n"
            "  width: 35px;\n"
            "  height: 35px;\n"
            "  cursor: pointer;\n"
        ...
        self.ispCheckBox.setStyleSheet(
            "QCheckBox {\n"
            "  width: 35px;\n"
            "  height: 35px;\n"
            "  cursor: pointer;\n"
        ...
        self.locationCheckBox = QtWidgets.QCheckBox(Dialog)
        self.locationCheckBox.setGeometry(QtCore.QRect(60, 430, 151, 20))
        font = QtGui.QFont()
        font.setBold(True)
        self.locationCheckBox.setFont(font)
        self.locationCheckBox.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.locationCheckBox.setStyleSheet(
            "QCheckBox {\n"
            "  width: 35px;\n"
            "  height: 35px;\n"
            "  cursor: pointer;\n"
        ...
        self.latitudeCheckBox.setStyleSheet(
            "QCheckBox {\n"
            "  width: 35px;\n"
            "  height: 35px;\n"
            "  cursor: pointer;\n"
        ...
        self.longitudeCheckBox.setStyleSheet(
            "QCheckBox {\n"
            "  width: 35px;\n"
            "  height: 35px;\n"
            "  cursor: pointer;\n"
        ...
        self.no_connction_icon = QtGui.QPixmap(
            "main_program/source/ui_design/resources/pictures/no_connection_icon.png"
        )
        self.connected_icon = QtGui.QPixmap(
            "main_program/source/ui_design/resources/pictures/connected_icon.png"
        )
    ...
    def retranslateUi(self, Dialog):
        ...
        self.pushButton.setToolTip(
            _translate(
                "Dialog", "<html><head/><body><p>Examine the ENDPOINT!</p></body></html>"
            )
        )
        ...
        self.locationCheckBox.setText(_translate("Dialog", "Map location"))
