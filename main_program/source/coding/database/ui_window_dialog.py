...
"")
        ...
        self.locationCheckBox.setStyleSheet("QCheckBox {\n"
"  width: 35px;\n"
"  height: 35px;\n"
"  cursor: pointer;\n"
"  margin-right: -22px;\n"
...
"}")
        ...
        self.line.setGeometry(QtCore.QRect(200, 40, 71, 101))
        self.line.setFrameShape(QtWidgets.QFrame.VLine)
        self.line.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line.setObjectName("line")
        self.line_2 = QtWidgets.QFrame(Dialog)
        self.line_2.setGeometry(QtCore.QRect(30, 40, 51, 101))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.callstatusLabel.setText(_translate("Dialog", "Awaiting input..."))
        ...
        self.locationCheckBox.setToolTip(_translate("Dialog", "<html><head/><body><p>The IP user Internet Service Provider.</p><p><br/></p><p>Examples: Mobin Net Communication Company, SURFnet II c.</p></body></html>"))
        self.locationCheckBox.setText(_translate("Dialog", "Show map location"))
